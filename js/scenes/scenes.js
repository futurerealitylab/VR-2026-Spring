...
export default () => {
   ...
   return {
      ...
      scenes: [ 
         ...
         { name: "headGazeExercise" , path: "./headGazeExercise.js" , public: true },
         { name: "spiritExercise" , path: "./spirit_exercise.js" , public: true },
         { name: "final" , path: "./final_project.js" , public: true }
      ]
   };
}
